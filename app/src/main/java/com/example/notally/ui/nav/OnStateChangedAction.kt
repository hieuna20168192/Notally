...
/**
 * A state change action that tells the calling client when a open-sheet specific menu should be used.
 */
...
/**
 * A state change action that handles show the fab when the sheet is hidden and hiding the fab when the sheet
 * is not hidden.
 */
...
/**
 * A state change action that sets a view's visibility depending on the sheet is hidden or not.
 *
 * By default, the view will be hidden when the sheet is hidden and shown when the sheet is shown (not hidden).
 * If reverse is set to true, the view will be shown when the sheet is hidden and hidden when the sheet is shown (not hidden).
 */
