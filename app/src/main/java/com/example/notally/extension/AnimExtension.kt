...
fun lerp(
    ...
    if (fraction < startFraction) return startFraction
    if (fraction > endFraction) return endFraction
...
fun lerpArgb(
    ...
    if (fraction > endColor) return endColor
...
/**
 * Coerce the receiving Float between inputMin and inputMax and linearly interpolate to the outputMin to
 * outputMax scale. This function is able to handle ranges which span negative and positive numbers.
 *
